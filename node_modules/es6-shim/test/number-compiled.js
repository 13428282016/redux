...
describe('Number', function () {
  ...
  var valueOfThree = { valueOf: function () {
      return 3;
    } };
  var valueOfNaN = { valueOf: function () {
      return NaN;
    } };
  var valueOfThrows = { valueOf: function () {
      throw Object(17);
    } };
  var toStringThrows = { toString: function () {
      throw Object(42);
    } };
  ...
  var nonNumbers = [undefined, true, false, null, {}, [], 'str', '', valueOfThree, valueOfNaN, valueOfThrows, toStringThrows, toPrimitiveThrows, /a/g];
  ...
  describe('constructor', function () {
    ...
    it('works with binary literals in string form', function () {
      ...
      expect(Number({ toString: function () {
          return '0b100';
        }, valueOf: function () {
          return '0b101';
        } })).to.equal(5);
    ...
    it('should work with well formed and poorly formed objects', function () {
      ...
      expect(Number({ valueOf: '1.1', toString: function () {
          return '2.2';
        } })).to.equal(2.2);
      expect(Number({ valueOf: function () {
          return '1.1';
        }, toString: '2.2' })).to.equal(1.1);
      expect(Number({ valueOf: function () {
          return '1.1';
        }, toString: function () {
          return '2.2';
        } })).to.equal(1.1);
      expect(String(Number({ valueOf: function () {
          return '-0x1a2b3c';
        } }))).to.equal('NaN');
      expect(String(Number({ toString: function () {
          return '-0x1a2b3c';
        } }))).to.equal('NaN');
      expect(Number({ valueOf: function () {
          return '0o12345';
