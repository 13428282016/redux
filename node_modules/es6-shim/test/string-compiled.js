  ...
  describe('String', function () {
    ...
    describe('#repeat()', function () {
      ...
      it('should throw a RangeError when negative or infinite', function () {
        expect(function negativeOne() {
          return 'test'.repeat(-1);
        }).to['throw'](RangeError);
        expect(function infinite() {
          return 'test'.repeat(Infinity);
        }).to['throw'](RangeError);
      });
      ...
      it('should coerce to an integer', function () {
        ...
        expect('test'.repeat({})).to.eql('');
        expect('test'.repeat([])).to.eql('');
        expect('test'.repeat({ valueOf: function () {
            return 2;
          } })).to.eql('testtest');
      });
    ...
    describe('#startsWith()', function () {
      ...
      it('should coerce to a string', function () {
        expect('abcd'.startsWith({ toString: function () {
            return 'ab';
          } })).to.equal(true);
        expect('abcd'.startsWith({ toString: function () {
            return 'foo';
      ...
      it('should not allow a regex', function () {
        expect(function () {
          return 'abcd'.startsWith(/abc/);
        }).to['throw'](TypeError);
        expect(function () {
          return 'abcd'.startsWith(new RegExp('abc'));
        }).to['throw'](TypeError);
      });
    ...
    describe('#endsWith()', function () {
      ...
      it('should coerce to a string', function () {
        expect('abcd'.endsWith({ toString: function () {
            return 'cd';
          } })).to.equal(true);
        expect('abcd'.endsWith({ toString: function () {
            return 'foo';
      ...
      it('should not allow a regex', function () {
        expect(function () {
          return 'abcd'.endsWith(/abc/);
        }).to['throw'](TypeError);
        expect(function () {
          return 'abcd'.endsWith(new RegExp('abc'));
        }).to['throw'](TypeError);
      });
    ...
    describe('.fromCodePoint()', function () {
      ...
      it('throws a RangeError', function () {
        var invalidValues = ['abc', {}, -1, 0x10FFFF + 1];
    ...
    describe('#search()', function () {
      ...
      ifSymbolsDescribe('Symbol.search', function () {
        ...
        it('is respected', function () {
          var str = Object('a');
          var obj = {};
          obj[Symbol.search] = function (string) {
            return string === str && this === obj;
          };
    ...
    describe('#split()', function () {
      ...
      ifSymbolsDescribe('Symbol.split', function () {
        ...
        it('respects Symbol.split', function () {
          ...
          var obj = {};
          obj[Symbol.split] = function (string, limit) {
            return string === str && limit === limitVal && this === obj;
          };
    ...
    describe('#match()', function () {
      ...
      ifSymbolsDescribe('Symbol.match', function () {
        ...
        it('respects Symbol.match', function () {
          var str = Object('a');
          var obj = {};
          obj[Symbol.match] = function (string) {
            return string === str && this === obj;
          };
