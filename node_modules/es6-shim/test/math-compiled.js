...
describe('Math', function () {
  ...
  var valueOfIsNaN = { valueOf: function () {
      return NaN;
    } };
  var valueOfIsInfinity = { valueOf: function () {
      return Infinity;
    } };
  ...
  describe('.fround()', function () {
    ...
    it('works for zeroes and infinities', function () {
      ...
      expect(isPositiveZero(Math.fround({ valueOf: function () {
          return 0;
        } }))).to.equal(true);
      expect(isNegativeZero(Math.fround(-0))).to.equal(true);
      expect(isNegativeZero(Math.fround({ valueOf: function () {
          return -0;
        } }))).to.equal(true);
      expect(Math.fround(Infinity)).to.equal(Infinity);
      expect(Math.fround({ valueOf: function () {
          return Infinity;
        } })).to.equal(Infinity);
      expect(Math.fround(-Infinity)).to.equal(-Infinity);
      expect(Math.fround({ valueOf: function () {
