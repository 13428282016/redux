...
Assertion.addMethod('theSameSet', function (otherArray) {
  ...
  this.assert(diff.length === 0, 'expected #{this} to be equal to #{exp} (as sets, i.e. no order)', array, otherArray);
});
...
describe('Set', function () {
  ...
  it('should work as expected', function () {
    ...
    [true, false].forEach(function (slowkeys) {
      ...
      range(1, 20).forEach(function (number) {
        ...
        if (slowkeys) {
          testSet(set, Object(String(number)));
        }
      });
      ...
      ['hasOwnProperty', 'constructor', 'toString', 'isPrototypeOf', '__proto__', '__parent__', '__count__'].forEach(function (prop) {
        testSet(set, prop);
      });
    });
  });
  ...
  describe('has an iterator that works with Array.from', function () {
    ...
    it('works with Set#entries()', function () {
      expect(new Set(values).entries()).to.have.iterations([[1, 1], [NaN, NaN], [false, false], [true, true], [null, null], [undefined, undefined], ['a', 'a']]);
    });
  });
