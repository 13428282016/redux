...
describe('Map', function () {
  ...
  it('should map values correctly', function () {
    ...
    [true, false].forEach(function (slowkeys) {
      ...
      ['hasOwnProperty', 'constructor', 'toString', 'isPrototypeOf', '__proto__', '__parent__', '__count__'].forEach(function (key) {
        testMapping(map, key, {});
      });
    });
  });
  ...
  describe('#entries()', function () {
    ...
    it('throws when called on a non-Map', function () {
      ...
      nonMaps.forEach(function (nonMap) {
        expect(function () {
          return Map.prototype.entries.call(nonMap);
  ...
  it('should preserve insertion order', function () {
    var convertToPairs = function (item) {
      return [item, true];
    };
    var arr1 = ['d', 'a', 'b'];
    var arr2 = [3, 2, 'z', 'a', 1];
