...
describe('Date', function () {
    ...
    describe('constructor', function () {
        it('works with standard formats', function () {
            ...
            expect(new Date('2034-03-01T00:00:00.000Z') - new Date('2034-02-27T23:59:59.999Z')).toBe(86400001); //          86400001      86400001      86400001      86400001             1
        });
    ...
    describe('.parse()', function () {
        ...
        it('should work', function () {
            ...
            // https://github.com/es-shims/es5-shim/issues/80 Safari bug with leap day
            expect(Date.parse('2034-03-01T00:00:00.000Z') - Date.parse('2034-02-27T23:59:59.999Z')).toBe(86400001); //         86400001      86400001      86400001      86400001             1
        });
...
//# sourceMappingURL=s-date-compiled.js.map